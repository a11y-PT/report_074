---
website: "Associação para a Inclusão do Cidadão com Necessidades Especiais"          # Entre as aspas escreve o nome do website
date: "10/06/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://associacaoincluir.pt/"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://associacaoincluir.pt/acessibilidade/" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "Associação INCLUIR"         # Entre as aspas escrever o nome do owner do website
